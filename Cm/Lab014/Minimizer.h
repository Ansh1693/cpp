...
long Minimizer::Golden(tInterval A) {
    if (I.isZero())
        throw myException("Error:- Golden Search: Zero interval for search.\n");
    if (!I.isInitialized())
        throw myException("Error:- Golden Search: Interval not initialized for search.\n");
    if (T == POLYNOMIAL && P.isZero()) throw myException("Error:- Golden Search: Polynomial not initialized.\n");
    if (T == FUNCTION && F.isZero()) throw myException("Error:- Golden Search: Function not initialized.\n");
    double d,p,x1,x2,a=A.x,b=A.y;
    long COUNT =0;
    d= b-a;
    p= 0.6180339;
    double tol= eps;
...
long Minimizer::Fibonacci(tInterval A) {
    if (I.isZero())
        throw myException("Error:- LinearSearch: Zero interval for search.\n");
    if (!I.isInitialized())
        throw myException("Error:- LinearSearch: Interval not initialized for search.\n");
    if (T == POLYNOMIAL && P.isZero()) throw myException("Error:- LinearSearch: Polynomial not initialized.\n");
    if (T == FUNCTION && F.isZero()) throw myException("Error:- LinearSearch: Function not initialized.\n");
    double d,x1,x2,a=A.x,b=A.y,t1,t0;
    t1=1;
    t0=1;
    long COUNT =0,N;
    N=1;
...
long Minimizer::Binary(tInterval A) {
    if (I.isZero())
        throw myException("Error:- LinearSearch: Zero interval for search.\n");
    if (!I.isInitialized())
        throw myException("Error:- LinearSearch: Interval not initialized for search.\n");
